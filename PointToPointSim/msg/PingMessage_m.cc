...
const char * PingMessage::getMsg() const
{
    return this->msg.c_str();
}

void PingMessage::setMsg(const char * msg)
{
    this->msg = msg;
}
...
PingMessageDescriptor::PingMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(PingMessage)), "omnetpp::cMessage")
{
...
int PingMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "msg") == 0) return baseIndex + 0;
...
int PingMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    PingMessage *pp = omnetpp::fromAnyPtr<PingMessage>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void PingMessageDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    PingMessage *pp = omnetpp::fromAnyPtr<PingMessage>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'PingMessage'", field);
    }
}

const char *PingMessageDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string PingMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PingMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PingMessage'", field);
    }
}

omnetpp::cValue PingMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'PingMessage' as cValue -- field index out of range?", field);
    }
}

void PingMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::any_ptr PingMessageDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PingMessageDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
